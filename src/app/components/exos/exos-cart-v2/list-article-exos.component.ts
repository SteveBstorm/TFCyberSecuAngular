...
import { article } from './system-add-article/article';



@Component({
  selector: 'app-list-article-exos',
  templateUrl: './list-article-exos.component.html',
  styleUrls: ['./list-article-exos.component.scss']
})
export class ListArticleExosComponent {
